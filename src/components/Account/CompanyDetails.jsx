    ...
    const ActionButtons = useMemo(() => (
        mode === 'view' ?
            isEditorView ?
                ...
                <Button className="tour-edit-company" variant="outlined" size="small" onClick={() => setMode('edit')}><ModeEditOutlinedIcon sx={{ fontSize: 16, verticalAlign: 'top', mt: '-2px' }} /> Edit</Button> :
            isEditorView ?
                null :
